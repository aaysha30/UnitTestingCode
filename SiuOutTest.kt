...
//        var siuS12=outcome as SIU_S12
      ...
      //  Assert.assertEquals(,siuS12.msh);
        ...
        assertNull(siuS12.sch.insertFillerContactPerson(0).idNumber.value)
        assertNull(siuS12.sch.fillerContactPerson.get(0).idNumber.value)
        assertNull(siuS12.sch.fillerContactPerson.get(0).givenName.value)
